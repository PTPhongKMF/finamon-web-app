...
function TopNavBar() {
  ...
  return (
    <header className="w-full bg-white shadow px-6 py-3 sticky top-0 z-50 bg-linear-to-br from-[#B2F2BB] to-[#FFF3BF]">
      <div className="grid grid-cols-3 items-center">
        <div className="justify-self-start">
          <h1 className="text-4xl font-bold text-gray-800 hover:text-blue-500 ml-20">
        ...
        <div className="flex justify-self-end">
          <button
            className="px-4 py-2 mx-4 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold rounded-lg shadow-md transition duration-200">
            Đến sổ quản lí
          </button>
